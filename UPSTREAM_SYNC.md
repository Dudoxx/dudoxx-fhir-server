...
```bash
origin    git@github.com:Dudoxx/ddx-fhir.git
...
| Remote | Purpose | URL |
|--------|---------|-----|
| **origin** | Your Dudoxx customizations | `git@github.com:Dudoxx/ddx-fhir.git` |
...
**Expected output:**
```
origin    git@github.com:Dudoxx/ddx-fhir.git (fetch)
origin    git@github.com:Dudoxx/ddx-fhir.git (push)
